 ...
 */
class RollingAmountViewV2 @JvmOverloads constructor(
    context: Context,
    ...
    private fun initDigitsTextView(sidePadding: Int = 6): TextView {
    ...
    inner class DigitsAdapter : RecyclerView.Adapter<DigitsAdapter.DigitsViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DigitsViewHolder {
            return DigitsViewHolder(initDigitsTextView())
        }
