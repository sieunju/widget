...
class CustomTextView @JvmOverloads constructor(
    ...
    internal val enableItem = Item()
    internal val disableItem = Item()
    internal var isClicked: Boolean = true

    // [s] 자동 크기 조절
    internal var isAutoSizing: Boolean = false
    internal var autoMaxSize: Int = -1
    internal var autoMinSize: Int = -1
    internal var spacingAdd: Float = 0.0F
    internal var spacingMult: Float = 1.0F
    // [e] 자동 크기 조절
