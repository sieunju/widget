...
class ParallaxViewHolderFragment : Fragment(R.layout.fragment_parallax) {
	...
	class Adapter(private val list: ArrayList<UiModel>) :
		...
		class HeaderViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
			...
			private val tempImgUrl = "https://cdn.qtzz.synology.me/resource/img/20210921/1632238064795dwalkkz7dea.png"
			...
			init {
				...
				GlobalScope.launch(Dispatchers.Main) {
					imgThumb.setImageBitmap(ImageLoader.imageBitmap(tempImgUrl, itemView.context.deviceWidth(), 200.dp))
				}
			}
